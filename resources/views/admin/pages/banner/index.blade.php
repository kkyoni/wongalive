...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2><i class="fa fa-picture-o"></i> Banner Management</h2>
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="{{ route('admin.dashboard') }}">Home</a>
			</li>
			<li class="breadcrumb-item active">
				<strong>Banner Table</strong>
			</li>
		</ol>
	</div>
</div>
			...
			<div class="ibox ">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn them" href="{{route('admin.banner.create')}}">
							Add Banner
						</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title pull-left" id="exampleModalLabel1">Banner Detail</h5>
...
<script type="text/javascript">
	$(document).on("click","a.deletebanner",function(e){
		var row = $(this);
	...
	$(document).on("click",".changeStatusRecord",function(e){
		...
		swal({
			...
			if (isConfirm) {
				...
				swal("Cancelled", "Banner Status is safe :)", "error");
			}
		});
		return false;
	})
...
<script type="text/javascript">
    $(document).on("click","a.ShowBanner",function(e){
    var row = $(this);
    var id = $(this).attr('data-id');
    $.ajax({
