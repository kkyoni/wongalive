<div class="form-group row {{ $errors->has('description') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Admin Content</strong> <span class="text-danger">*</span></label>
...
<div class="form-group row {{ $errors->has('status') ? 'has-error' : '' }}"><label class="col-sm-3 col-form-label"><strong>Status</strong></label>
	<div class="col-sm-6 inline-block">
		<div class="i-checks">
			<label>
				{{ Form::radio('status', 'resolved' ,true,['id'=> 'resolved']) }} <i></i> Resolved
			</label>
			<label>
				{{ Form::radio('status', 'pending' ,false,['id' => 'pending']) }}
				<i></i> Pending
			</label>
		</div>
		<span class="help-block">
