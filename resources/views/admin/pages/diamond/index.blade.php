...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-lg-12">
		<h2><i class="fa fa-diamond"></i> Diamond Management</h2>
		<ol class="breadcrumb">
			<li class="breadcrumb-item">
				<a href="{{ route('admin.dashboard') }}">Home</a>
			</li>
			<li class="breadcrumb-item active">
				<strong>Diamond Table</strong>
			</li>
		</ol>
	</div>
</div>
			...
			<div class="ibox ">
				<div class="ibox-content">
					<div class="col-md-12 text-right">
						<a class="btn btn-primary btn-sm pull-right mb-3 op-btn them" href="{{route('admin.diamond.create')}}">
							Add Diamond Pack
						</a>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title pull-left" id="exampleModalLabel1">Diamond Detail</h5>
...
<script type="text/javascript">
	$(document).on("click","a.deletepack",function(e){
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{route('admin.diamond.delete',[''])}}"+"/"+id,
					type: 'post',
	...
	$(document).on("click",".changeStatusRecord",function(e){
		...
		swal({
			...
			if (isConfirm) {
				$.ajax({
					url:"{{ route('admin.diamond.change_status') }}",
					type: 'post',
					data: {"_method": 'post',
					'id':id,
					"_token": "{{ csrf_token() }}"
...
<script type="text/javascript">
    $(document).on("click","a.ShowDiamond",function(e){
    var row = $(this);
    var id = $(this).attr('data-id');
    $.ajax({
      url:"{{ route('admin.diamond.show') }}",
      type: 'get',
      data: {id: id},
      success:function(msg){
        $('.testdata').html(msg);
